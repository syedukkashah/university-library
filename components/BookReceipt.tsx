      ...
      <section id="book-ticket">
        <div className="flex items-center gap-2 px-8">
          <Image
            ...
            className="object-contain"
          />
          <p className="text-2xl font-semibold text-white">BookMyst</p>
        </div>
